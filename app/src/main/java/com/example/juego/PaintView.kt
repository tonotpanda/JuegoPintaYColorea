...
class PaintView(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    private fun setFilledPixelsForNextImage() {
        ...
        when (currentImageIndex) {
            ...
            2 -> filledPixels = (totalPixels * 0.078).toInt() //caracol
            ...
            7 -> filledPixels = (totalPixels * 0.241).toInt() //medusa
            8 -> filledPixels = (totalPixels * 0.0168).toInt() //mono1
            9 -> filledPixels = (totalPixels * 0.07).toInt() //mono2
            10 -> filledPixels = (totalPixels * 0.185).toInt() //mono3
            11 -> filledPixels = (totalPixels * 0.08).toInt() //nube
            12 -> filledPixels = (totalPixels * 0.065).toInt() //pez
            13 -> filledPixels = (totalPixels * 0.0635).toInt() //pulpo
            14 -> filledPixels = (totalPixels * 0.368).toInt() //seta
